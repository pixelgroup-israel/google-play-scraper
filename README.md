...
## Documentation
[docs/README.md](https://github.com/pixel-group/google-play-scraper/tree/master/docs/README.md)
...
Changes are documented in the [releases page](https://github.com/pixel-group/google-play-scraper/releases).

# License

The library is open-sourced software licensed under the [MIT License](https://github.com/pixel-group/google-play-scraper/blob/master/LICENSE).
